...
// ==============================================================
#ifndef __music_mul_42ns_33OgC__HH__
#define __music_mul_42ns_33OgC__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(music_mul_42ns_33OgC) {
    ...
    SC_CTOR(music_mul_42ns_33OgC):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
