...
// ==============================================================
#ifndef __music_mul_80ns_24fYi__HH__
#define __music_mul_80ns_24fYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(music_mul_80ns_24fYi) {
    ...
    SC_CTOR(music_mul_80ns_24fYi):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
