...
// ==============================================================
#ifndef __music_mul_64s_63nPgM__HH__
#define __music_mul_64s_63nPgM__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(music_mul_64s_63nPgM) {
    ...
    SC_CTOR(music_mul_64s_63nPgM):  ACMP_mul_su_U ("ACMP_mul_su_U") {
