...
// ==============================================================
#ifndef __music_mul_56ns_52Mgi__HH__
#define __music_mul_56ns_52Mgi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(music_mul_56ns_52Mgi) {
    ...
    SC_CTOR(music_mul_56ns_52Mgi):  ACMP_mul_us_U ("ACMP_mul_us_U") {
