...
// ==============================================================
#ifndef __music_fcmp_32ns_3pcA__HH__
#define __music_fcmp_32ns_3pcA__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(music_fcmp_32ns_3pcA) {
    ...
    SC_CTOR(music_fcmp_32ns_3pcA):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
