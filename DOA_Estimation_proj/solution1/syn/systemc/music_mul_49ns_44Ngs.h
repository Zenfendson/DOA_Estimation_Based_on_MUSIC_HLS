...
// ==============================================================
#ifndef __music_mul_49ns_44Ngs__HH__
#define __music_mul_49ns_44Ngs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(music_mul_49ns_44Ngs) {
    ...
    SC_CTOR(music_mul_49ns_44Ngs):  ACMP_mul_us_U ("ACMP_mul_us_U") {
