...
// ==============================================================
#ifndef __music_mul_170ns_5KfY__HH__
#define __music_mul_170ns_5KfY__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(music_mul_170ns_5KfY) {
    ...
    SC_CTOR(music_mul_170ns_5KfY):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
