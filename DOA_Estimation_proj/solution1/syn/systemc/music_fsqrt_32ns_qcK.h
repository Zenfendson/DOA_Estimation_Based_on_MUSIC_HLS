...
// ==============================================================
#ifndef __music_fsqrt_32ns_qcK__HH__
#define __music_fsqrt_32ns_qcK__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(music_fsqrt_32ns_qcK) {
    ...
    SC_CTOR(music_fsqrt_32ns_qcK):  ACMP_fsqrt_U ("ACMP_fsqrt_U") {
