...
// ==============================================================
#ifndef __music_faddfsub_32ibs__HH__
#define __music_faddfsub_32ibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(music_faddfsub_32ibs) {
    ...
    SC_CTOR(music_faddfsub_32ibs):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
